...
Simulador de caixa eletrônico desenvolvido em Java como projeto da disciplina de Desenvolvimento Mobile do 3º período de Análise e Desenvolvimento de Sistemas.
...
- **Saque**: Realização de saques com validação de saldo
- **Depósito**: Adição de valores à conta
- **Interface intuitiva**: Menu interativo via terminal
